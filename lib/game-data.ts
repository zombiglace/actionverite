...
export const friendsData: GameData = {
  ...
  dares: {
    ...
    hot: [
      ...
      "As-tu déjà été surpris(e) en plein acte ? Raconte (si possible !).",
    ],
  },
}
...
export const coupleData: GameData = {
  truths: {
    ...
    hot: [
      ...
      "Prefères-tu les hommes/femmes domina(teur/trice) ou soumise?",
    ],
  },
  dares: {
    soft: [
    ...
    hot: [
      ...
      "Fait un defilé nu",
      "Fait moi un orgasme",
      "Pendant 2 minutes ton partenaire doit te branler",
      "Chauffe ton partenaire pendant 3 minutes",
      "Touche ton partenaire en bah la",
      "Fait un smiley sur la fesse gauche",
      "Cache un preservatif et si ton partenaire le trouve vous le faite en 2minutes si vous etes consentant evidament !",
      "Raconte le début d'une histoire érotique (inventée ou non) et arrête-toi au moment le plus crucial et poursuivez l action apres si vous etes consentant evidament !",
      "Masse les pieds de ton partenaire",
      "Fait le loup mechant",
      "Dis lui ce qu il/elle doit faire avec ses mains sur toi",
      "Il/elle doit ecrire sur un papier ce qu il/elle veut faire avec toi et tu dois le cacher et il/elle doit recherche et si c est trouvé en moins de 2minutes tu dois effectué cette action",
      "Joue a un jeu et il/elle doit te br pendant ta partie",
      "Fixe-le/la intensément sans parler pendant 10 secondes.",
      "Dit camion pouet pouet",
      "Retire un vêtement de l’autre uniquement à l’aide de la bouche",
      "Amuse toi avec son cavu",
      "Embrassez vous contre un mur pendant 2 minutes",
      "Regardez un webtoon herotique dark romance et continuer l action",
      "Faite le dans le noir ",
      "Eteignez la lumiere et rallumez la quand vous etes nus",
      "Suce un doigt de l autre pendant 10 seconde",
      "Rp: tu est policier/iere il/elle vient de voler fait une fouille complete #peut etre skip si c est trop genant",
      "Tu n as plus le droit de bouger et ton partenaire fait ce qu il veut de toi pendant 2 minutes",
      "Embrasse le dos de l autre en faisant un chiffre et si il/elle se trompe donne lui une féssée",
      "Regardez vous et le premier a rire recoit une petite punition",
      "Rourne sur toi pendant 10 sencondes et embrasse ton partenaire",
      "Bande les yeux de l autre et fait toucher du bout du doigt un endroit et il/elle doit deviner ou c est",
      "Mets les vetement de l autre",
      "Met un sous-vetement propre de l autre",
      "decrit ton crotty du matin",
      "",
    ],
  },
}
